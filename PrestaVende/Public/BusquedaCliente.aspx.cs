        ...
        protected void gvCliente_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "crear")
                {
                    ...
                    TableCell nombre_cliente = selectedRow.Cells[5];
                    CLASS.cs_cliente.Id_cliente = id_cliente.Text.ToString();
                    CLASS.cs_cliente.Nombre_cliente = nombre_cliente.Text.ToString();
