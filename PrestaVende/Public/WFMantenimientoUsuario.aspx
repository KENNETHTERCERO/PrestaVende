<%@ Page Language="C#" MasterPageFile="~/Public/PrestaVende.Master" AutoEventWireup="true" CodeBehind="WFMantenimientoUsuario.aspx.cs" Inherits="PrestaVende.Public.WFMantenimientoUsuario" %>
                    ...
                    <div class="col-sm-2 sidenav">
                        ...
                        <h2>Opciones</h2>
                            <div class=".btn-group-vertical">
                                ...
                                <br />
                                <br />
                                <asp:Button ID="btnCambiarEstado" runat="server" Width="200px" Text="Cambiar Estado" class="btn btn-info" Visible="false" OnClick="btnCambiarEstado_Click" />
                                <br />
                                <br />
                                <br />
                                    ...
                                    <div id="div_ingresa_datos" runat="server" visible="false">
                                        <div>
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <big><asp:Label ID="lblPassword" runat="server" Text="CONTRASEÑA"></asp:Label></big>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <big><asp:Label ID="lblRol" runat="server" Text="ROL DEL USUARIO"></asp:Label></big>
                                                    </td>
                                                    <td>
                                                         <asp:DropDownList ID="ddlRol" runat="server" CssClass="form-control" AutoPostBack="true"></asp:DropDownList>
                                                    </td>
                                                </tr>    
