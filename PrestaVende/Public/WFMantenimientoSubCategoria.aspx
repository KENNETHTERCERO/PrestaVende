<%@ Page Title="" Language="C#" MasterPageFile="~/Public/PrestaVende.Master" AutoEventWireup="true" CodeBehind="WFMantenimientoSubCategoria.aspx.cs" Inherits="PrestaVende.Public.WFMantenimientoSubCategoria" %>
                            ...
                            <div class="panel-heading">
                                <div style="position: relative;">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <h1>Mantenimiento Sub Categoria &nbsp;&nbsp;</h1>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                </table>
                                ...
                                <center>
                                    ...
                                    <div id="div_ingresa_datos" runat="server" visible="true">
                                        <div>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <big><asp:Label ID="lblIdSubCategoria" runat="server" Text="ID SUB CATEGORIA"></asp:Label></big>
                                                    </td>
                                                    <td>
                                                        <center>
                                                        <asp:Label ID="ddIdSubCategoria" runat="server" Text="0"  ></asp:Label>
                                                        </center>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <big><asp:Label ID="lblIdCategoria" runat="server" Text="CATEGORIA"></asp:Label></big>
                                                    </td>
                                                    <td>
                                                         <asp:DropDownList ID="ddIdCategoria" runat="server" class="form-control"></asp:DropDownList>
                                                    </td>
                                                </tr>         
                                                <tr>
                                                    <td>
                                                        <big><asp:Label ID="lblSubCategoria" runat="server" Text="DESCRIPCIÓN SUB CATEGORIA"></asp:Label></big>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtDescripcionSubCategoria" runat="server" class="form-control"/>
                                                    </td>
                                                </tr>
                                    ...
                                    <div id="div_gridView" runat="server" visible ="false">
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GrdVSubCategoria" runat="server" Width="100%" CssClass="footable" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <FooterStyle BackColor="#FF9A32" />
                                                                ...
                                                                <asp:BoundField DataField="id_sub_categoria" HeaderText="<center> ID </center>" SortExpression="id_sub_categoria" HtmlEncode="false"/>                                                            
                                                                <asp:BoundField DataField="categoria" HeaderText="<center> SUB CATEGORIA </center>" SortExpression="categoria" HtmlEncode="false" />
                                                                <asp:BoundField DataField="sub_categoria" HeaderText="<center> DESCRIPCION </center>" SortExpression="sub_categoria" HtmlEncode="false" />
