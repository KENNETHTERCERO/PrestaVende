<%@ Page Language="C#"  MasterPageFile="~/Public/PrestaVende.Master" AutoEventWireup="true" CodeBehind="TrasladoArticulos.aspx.cs" Inherits="PrestaVende.Public.TrasladoArticulos" %>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div style="position: relative;">
                                    <h1>Traslado de artículos entre Sucursales&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h1>
                                    <table>
                                         <tr>
                                            <td>
                                        ...
                                        <tr>                                            
                                            <td><big>
                                                <asp:Label ID="lblSucursalOrigen" runat="server">SUCURSAL ORIGEN:&nbsp;&nbsp;</asp:Label>
                                                </big></td>
                                            <td colspan="2">
                                                 <asp:DropDownList ID="ddlSucursalOrigen" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlSucursalOrigen_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>                                            
                                            <td><big>
                                                <asp:Label ID="lblSucursalDestino" runat="server">SUCURSAL DESTINO:&nbsp;&nbsp;</asp:Label>
                                                </big></td>
                                            <td colspan="2">
                                                 <asp:DropDownList ID="ddlSucursalDestino" runat="server" CssClass="form-control">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><big>
                                                <asp:Label ID="articulos" runat="server" Text="ARTICULOS:"></asp:Label>
                                                </big></td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Button ID="btnAgregar" runat="server" CssClass="btn btn-info" OnClick="btnAgregar_Click" Text="Agregar articulo" Visible="true" Width="200px" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><big>
                                            ...
                                            <td>
                                                <center>
                                                    <big>
                                                    <asp:Label ID="lblNumeroFactura" runat="server" Text="0"></asp:Label>
                                                    </big>
                                                </center>
                                            </td>
                                        </tr>
