<%@ Page Title="" Language="C#" MasterPageFile="~/Public/PrestaVende.Master" AutoEventWireup="true" CodeBehind="AnulacionFactura.aspx.cs" Inherits="PrestaVende.Public.AnulacionFactura" %>
                    ...
                    <div class="col-sm-2 sidenav">
                        ...
                        <h2>Opciones</h2>
                            <div class=".btn-group-vertical">                                
                                ...
                                <br />
                                <br />
                                <asp:Button ID="btnGenerar" runat="server" Width="200px" Text="ANULAR FACTURA" class="btn btn-danger" Visible="true" OnClick="btnGenerar_Click"/>
                                <br />
                                <br />
                                <br />
                            </div>
