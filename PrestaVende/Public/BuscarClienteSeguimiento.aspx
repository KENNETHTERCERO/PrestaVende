<%@ Page Language="C#" MasterPageFile="~/Public/PrestaVende.Master" AutoEventWireup="true" CodeBehind="BuscarClienteSeguimiento.aspx.cs" Inherits="PrestaVende.Public.BuscarClienteSeguimiento" %>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="gvCliente" runat="server" Width="100%" CssClass="footable" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            <asp:ButtonField ButtonType="Button" ControlStyle-CssClass="btn btn-success" FooterStyle-BackColor="#ff9a32" CommandName="crear" HeaderText="<center>Ver<br/>Prestamos </center>" Text="->" >
