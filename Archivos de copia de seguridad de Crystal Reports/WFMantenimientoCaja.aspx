<%@ Page Title="" Language="C#" MasterPageFile="~/Public/PrestaVende.Master" AutoEventWireup="true" CodeBehind="WFMantenimientoCaja.aspx.cs" Inherits="PrestaVende.Public.WFMantenimientoCaja" %>
                                ...
                                <center>
                                    ...
                                    <div id="div_ingresa_datos" runat="server" visible="true">
                                        <div>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <big><asp:Label ID="lblIdCaja" runat="server" Text="ID CAJA "></asp:Label></big>
                                                    </td>
                                                    <td>
                                                        <center>
                                                        <asp:Label ID="ddidCaja" runat="server" Text="0"  ></asp:Label>
                                                        </center>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <big><asp:Label ID="lblidTipoCaja" runat="server" Text="TIPO CAJA "></asp:Label></big>
                                                    </td>
                                                    <td>
                                                         <asp:DropDownList ID="ddidTipoCaja" runat="server" class="form-control"></asp:DropDownList>
                                                    </td>
                                                </tr>    
                                                     
                                                <tr>
                                                    <td>
                                                        <big><asp:Label ID="lblNombreCaja" runat="server" Text="NOMBRE CAJA "></asp:Label></big>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtNombreCaja" runat="server" class="form-control"/>
                                                    </td>
                                                </tr>

                                                 <tr>
                                                    <td>
                                                        <big><asp:Label ID="lblSaldo" runat="server" Text="SALDO "></asp:Label></big>
                                                    </td>
                                                    <td>
                                    ...
                                    <div id="div_gridView" runat="server" visible ="false">
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GrdVCaja" runat="server" Width="100%" CssClass="footable" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <FooterStyle BackColor="#FF9A32" />
                                                                ...
                                                                <asp:BoundField DataField="id_caja" HeaderText="<center> ID </center>" SortExpression="id_caja" HtmlEncode="false"/>                                                            
                                                                <asp:BoundField DataField="sucursal" HeaderText="<center> SUCURSAL </center>" SortExpression="sucursal" HtmlEncode="false" />
                                                                <asp:BoundField DataField="tipo_caja" HeaderText="<center> TIPO CAJA </center>" SortExpression="tipo_caja" HtmlEncode="false" />
                                                                ...
                                                                <asp:BoundField DataField="saldo" HeaderText="<center> SALDO </center>" SortExpression="saldo"  HtmlEncode="false"/>                                                                
